...
function ScrollToExplore() {
  ...
  // =============================================
  {
    id: "animated-logo-dna",
    name: "Animated Logo DNA",
    description: "Componente React de logo animado com padrão de DNA em loop infinito vertical. Utiliza Framer Motion para animação suave e SVG com clip-path. Props customizáveis: size, speed, autoPlay e color.",
    category: "SVG Animation",
    code: `// ============================================
// ANIMATED LOGO COM DNA EM LOOP INFINITO
// ============================================
"use client";
...
export function AnimatedLogo({ 
  size = 60, 
  speed = 15, // Velocidade do loop em segundos
  autoPlay = true,
  color = "#000000"
}: AnimatedLogoProps) {
  ...
  // O DNA path fornecido (versão reduzida para exibição)
  const dnaPath = "M11.91,17.41c2.43.35,10.69-.12,13.25-.17..."; // Path completo do DNA
